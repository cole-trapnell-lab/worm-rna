...
barcode, and then split the sam file to single cell sam file based on a cut off value
'''
import sys
...
def split_samfile(sam_file, barcode_file, output_folder, cutoff):
    ...
    and generate the output samfile for single cells, generate the sample ID file in the output folder,
